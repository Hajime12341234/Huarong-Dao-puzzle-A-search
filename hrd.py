...
def get_successors(state):
    ...
    def can_move(piece, direction):
        ...
        # for each direction, we essentially check whether there is empty space in the direction to which the piece is moving
        ...
        return False # when pieces are at the end of the grid, and they can't go out of bound
